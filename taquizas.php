                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-3">
                        <div class="item-img" data-toggle="modal" data-bs-toggle="modal" data-target="#-modal" data-bs-target="#-modal">
                            <img src="imgs/35.jpg" alt="" data-slide-to="0" data-bs-slide-to="0" data-target="#lb-" data-bs-target="#lb-">
                        </div>
                    </div>
                    <div class="col-12 col-md-3 top">
                        <div class="item-img" data-toggle="modal" data-bs-toggle="modal" data-target="#-modal" data-bs-target="#-modal">
                            <img src="imgs/36.jpg" alt="" data-slide-to="1" data-bs-slide-to="1" data-target="#lb-" data-bs-target="#lb-">
                        </div>
                    </div>
                    <div class="col-12 col-md-3 top">
                        <div class="item-img" data-toggle="modal" data-bs-toggle="modal" data-target="#-modal" data-bs-target="#-modal">
                            <img src="imgs/37.jpg" alt="" data-slide-to="2" data-bs-slide-to="2" data-target="#lb-" data-bs-target="#lb-">
                        </div>
                    </div>
                    <div class="col-12 col-md-3 top">
                        <div class="item-img" data-toggle="modal" data-bs-toggle="modal" data-target="#-modal" data-bs-target="#-modal">
                            <img src="imgs/38.jpg" alt="" data-slide-to="3" data-bs-slide-to="3" data-target="#lb-" data-bs-target="#lb-">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="carousel slide" id="lb-" data-interval="NaN" data-bs-interval="NaN">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="d-block" src="imgs/35.jpg" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block" src="imgs/36.jpg" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block" src="imgs/37.jpg" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block" src="imgs/38.jpg" alt="">
                                    </div>
        ...
        <div class="container-fluid">
            <div class="row padding">
                <div class="col-12 col-lg-6 mt-5 mb-5">
                    ...
                    <div class="mt-3">
                        <img src="imgs/53.jpg" alt="">
                    </div>
                </div>
                <div class="col-12 col-lg-6 mt-5 mb-5">
                    <div>
                        <img src="imgs/48.jpg" alt="">
                    </div>
                    <div class="mt-3">
                        <img src="imgs/52.jpg" alt="">
                    </div>
                </div>                
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="wrapper">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-3">
                        <div class="item-img">
                            <img src="imgs/40.jpg" alt="" data-slide-to="0" data-bs-slide-to="0" data-target="#lb-" data-bs-target="#lb-">
                        </div>
                    </div>
                    <div class="col-12 col-md-3 top">
                        <div class="item-img">
                            <img src="imgs/41.jpg" alt="" data-slide-to="1" data-bs-slide-to="1" data-target="#lb-" data-bs-target="#lb-">
                        </div>
                    </div>
                    <div class="col-12 col-md-3 top">
                        <div class="item-img">
                            <img src="imgs/42.jpg" alt="" data-slide-to="2" data-bs-slide-to="2" data-target="#lb-" data-bs-target="#lb-">
                        </div>
                    </div>
                    <div class="col-12 col-md-3 top">
                        <div class="item-img">
                            <img src="imgs/43.jpg" alt="" data-slide-to="3" data-bs-slide-to="3" data-target="#lb-" data-bs-target="#lb-">
                        </div>
                    </div>
                    <div class="col-12 col-md-3 mt-4">
                        <div class="item-img">
                            <img src="imgs/44.jpg" alt="" data-slide-to="0" data-bs-slide-to="0" data-target="#lb-" data-bs-target="#lb-">
                        </div>
                    </div>
                    <div class="col-12 col-md-3 mt-4 top">
                        <div class="item-img">
                            <img src="imgs/45.jpg" alt="" data-slide-to="1" data-bs-slide-to="1" data-target="#lb-" data-bs-target="#lb-">
                        </div>
                    </div>
                    <div class="col-12 col-md-3 mt-4 top">
                        <div class="item-img">
                            <img src="imgs/46.jpg" alt="" data-slide-to="2" data-bs-slide-to="2" data-target="#lb-" data-bs-target="#lb-">
                        </div>
                    </div>
                    <div class="col-12 col-md-3 mt-4 top">
                        <div class="item-img">
                            <img src="imgs/47.jpg" alt="" data-slide-to="3" data-bs-slide-to="3" data-target="#lb-" data-bs-target="#lb-">
                        </div>
                    </div>
